        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <!-- Loading spinner -->
                    <div class="d-flex align-items-center justify-content-center" v-if="this.isLoading">
                        <div class="spinner-border text-primary" role="status">
                            <span class="sr-only">Loading...</span>
                        </div>
                        <p class="ml-2 mb-0">Loading ...</p>
                    </div>

                    <!-- Card for edit employee data -->
                    <div class="card" v-if="!this.isLoading">
...
export default {
    ...
    data: function (){
        return{
            isLoading : true, // display employee data or spinner
    ...
    methods:{
        getEmployeeDataAll(){
            axios.get(`/api/employees/complete-data/${this.$route.params.id}`)
            .then(result => {
