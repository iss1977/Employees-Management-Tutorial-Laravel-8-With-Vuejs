...
@section('content')
    ...
    <div class="container">
        <div class="row flex-nowrap">
            ...
            <a href="{{ route('departments.create') }}" class="ml-auto btn btn-primary mb-2">
                        ...
                        @foreach ($departments as $department)
                            <tr>
                                ...
                                <td style="text-align:center" class="d-flex justify-content-center">
                                    <a href="{{ route('departments.edit', $department->id) }}" class="btn btn-success btn-sm text-center"><i
                                    ...
                                    <form method="POST" action="{{ route('departments.destroy', $department->id) }}">
                                        ...
                                        onclick="deleteButtonClick(event, this, this.parentElement, '{{ $department->name }}')"
                                        data-confirmation-window-title="{{__('Confirm department deletion from database')}}"
                                        data-confirmation-window-text="{{__('Do you want to delete ').$department->name}}"
